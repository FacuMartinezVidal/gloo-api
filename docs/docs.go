...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/comments/{recipeId}/{commentId}/admin/{organizationId}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.GetAllCommentsAdminResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.GetRatesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateRateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.GetAllCommentsAdminResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "models.GetRatesResponse": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "Successfully retrieved rate"
                },
                "status": {
                    "type": "string",
                    "example": "success"
